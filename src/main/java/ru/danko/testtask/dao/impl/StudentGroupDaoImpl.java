...
public class StudentGroupDaoImpl implements StudentGroupDao{
    ...
    @Override
    public Optional<StudentGroup> findById(long id) throws DaoServiceException {
    ...
    public Optional<StudentGroup> findByNumber(String number) throws DaoServiceException {
        try (Connection connection = DbcpDataSource.getConnection()) {
            ...
            throw new DaoServiceException("Finding student group by number error", e);
        }
    }
    ...
    public List<StudentGroup> findAll() throws DaoServiceException {
        try (Connection connection = DbcpDataSource.getConnection()) {
            ...
            throw new DaoServiceException("Finding student groups error", e);
        }
    }

    @Override
    public boolean add(StudentGroup studentGroup) throws DaoServiceException {
        try (Connection connection = DbcpDataSource.getConnection();
    ...
    @Override
    public boolean update(StudentGroup studentGroup) throws DaoServiceException {
        try (Connection connection = DbcpDataSource.getConnection();
            ...
            throw new DaoServiceException("Update student group error", e);
        }
    }
